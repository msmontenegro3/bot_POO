...
$k = '{"inline_keyboard":[[{"text":"' .  $enunciado->armarRespuestas(3)[0]['respuesta'] . '","callback_data":1},{"text":"Conectarse a internet","callback_data":2},{"text":"Tama\u00f1o (pulgadas)","callback_data":3},{"text":"Espacio (GB)","callback_data":4}]]}';
