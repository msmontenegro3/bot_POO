...
class EjerciciosModel{
    ...
    public function setPuntuacion($id_usuario, $pregunta_id, $puntuacion, $intentos_fallidos)
    {
        ...
        UPDATE score_preguntas_usuarios SET score_pregunta = ' . $puntuacion  . ', intentos_fallidos = ' . $intentos_fallidos  . '
    ...
    {
        $dt = $this->conexion->query('INSERT INTO score_preguntas_usuarios (id_usuario, id_pregunta, score_pregunta, intentos_fallidos) VALUES 
