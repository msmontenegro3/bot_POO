...
class Ejercicio
{
    ...
    public function presentarPreguntas($array_param_preguntas, $id, $token)
    {
        ...
        if ($contador < $numero_preguntas) {
            ...
            $uno = 1;
            $line = '____________ <b><i>PREGUNTA ' . ($contador + $uno) .  '</i></b> ________________';
           ...
           // $this->feedback_pregunta = $arreglo_preguntas[$contador]['feedback'];
            ...
            $line2 = '____________ <b><i>fin pregunta '  . ($contador + $uno) .  '</i></b> ________________';
 ...
 */
        ...
        if ($intentos_fallidos != ($numero_respuestas - 1) && $respuesta_enviada == $respuesta_correcta){
           ...
           $feedback = $texto_respuesta . ' es la respuesta correcta!' .  $f->getFeedbackPorPregunta($pregunta_id)[0]['feedback'];
